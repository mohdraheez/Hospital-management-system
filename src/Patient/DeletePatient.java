...
public class DeletePatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 1260, -1));
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        String sql2 = "select name from patient where id = '" +search+"'";
        String sql4="Delete from appointment where pName ='"+search+"'";
        ...
        try {
            ...
            String sql3 = "Delete from appointment where pname ='"+name+"'";
