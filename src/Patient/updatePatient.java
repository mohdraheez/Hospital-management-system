...
public class updatePatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "name", "age", "gender", "phone", "status", "address", "disease", "date" }));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        String sql2;
        sql2 = "update patient set "+select+" = '"+ input +"'  where id ='"+no+"'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        patientActivity p = new patientActivity();
        p.setVisible(true);
        dispose();
